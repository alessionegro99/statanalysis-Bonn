...
## usage
# python3 script.py base_dir therm_drop Nt Ns beta use_nonplanar(blocksize) 
...
def get_potential (path, loop, *, seed=8220, samples=500, blocksize=200):
    ...
    assert len(data[0,:]) == wt_max*ws_max, f"Error: number of fields is != {wt_max*ws_max}"
